...
saveCallback=CustomJS(code="""window.open('http://localhost:8787/"""+"""downloadimg"""+"""');""")
...
def img1com():
  ...
  p.image_url(url=["http://localhost:8787/getimg"], x=0, y=0, w=1200, h=675,anchor='bottom_left')
