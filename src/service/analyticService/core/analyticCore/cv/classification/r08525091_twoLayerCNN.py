...
class r08525091_twoLayerCNN(classification):
    def trainAlgo(self):
        ...
        self.model.add(Conv2D(self.param['second_hidden_neuron'],(self.param['hidden_kernel_size'],self.param['hidden_kernel_size']),data_format='channels_last',activation=self.param['hidden_activation']))
        self.model.add(Dropout(self.param['dropout_rate'],None,None))
