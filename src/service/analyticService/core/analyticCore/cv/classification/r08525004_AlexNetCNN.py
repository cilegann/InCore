...
class r08525004_AlexNetCNN(classification):
    def trainAlgo(self):
        ...
        self.model.add(Conv2D(self.param['hidden_neuron']*2,(self.param['hidden_kernel_size'],self.param['hidden_kernel_size']),data_format='channels_last',padding='same',activation=self.param['hidden_activation']))
        self.model.add(MaxPooling2D(pool_size=(2,2),strides=(2,2)))
