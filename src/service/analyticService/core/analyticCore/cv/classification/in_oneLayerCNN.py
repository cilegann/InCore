...
class in_oneLayerCNN(classification):
    def trainAlgo(self):
        ...
        self.model.add(Conv2D(self.param['hidden_neuron'],(self.param['hidden_kernel_size'],self.param['hidden_kernel_size']),input_shape=(128,128,3),data_format='channels_last',activation=self.param['hidden_activation']))
        ...
        self.model.fit_generator(
            XYdataGenerator(self.inputData['X'],self.outputData['Y'],128,128,self.param['batch_size']),
    ...
    def predictAlgo(self):
        ...
        r=self.model.predict_generator(
            self.XdataGenerator(self.inputData['X'],128,128,self.param['batch_size']),
